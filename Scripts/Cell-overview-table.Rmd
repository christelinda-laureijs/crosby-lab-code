...
make_cell_summary_df <- function(include_all_treatments = "yes",
                                    list_of_treatments = NULL) {
table_data <-
  merge(pruned_eEPSC_df_for_table,
        pruned_sEPSC_df_for_table,
        by = "letter") %>%
...
# Add ability to filter categories as well

```{r}
make_cell_summary_df(include_all_treatments = "no",
                        list_of_treatments = c("Control", "PPP_and_HNMPA"))
```
